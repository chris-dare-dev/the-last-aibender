/**
 * Synthesized JSONL transcript-line generator (plan §3/§9.5).
 *
...
/**
 * Throw when `text` contains identity-shaped content (email address,
 * 12-digit run, token-shaped string). Every testkit generator screens its
 * free-text inputs through this guard; exported so fixture SUITES can also
 * audit whole corpora against the [X2] fixture policy.
 */
export function assertSynthesizedSafeText(text: string): void {
