...
describe('M5 protocol freeze registration', () => {
  it('advances the freeze marker + version', () => {
    ...
    // are carried forward UNCHANGED by the M6 freeze (1.3.0 → 1.4.0), the
    // M7 account-registry generalization (1.4.0 → 1.5.0, ICR-0013), and the
    // M8 backend-registry generalization (1.5.0 → 1.6.0, ICR-0016).
